...
import { parseStandingsCSV, parseMatchesCSV } from '../csv/service';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        <div className="bg-gray-900 p-10 rounded-[2.5rem] shadow-xl border border-gray-800 flex flex-col justify-between group hover:border-blue-500/30 transition-all">
          <div>
            ...
            <p className="text-[10px] text-slate-500 uppercase font-bold tracking-widest mt-2 mb-6 italic">Format: team, rank, played, won, drawn, lost, points, form</p>
          </div>
        ...
        <div className="bg-gray-900 p-10 rounded-[2.5rem] shadow-xl border border-gray-800 flex flex-col justify-between group hover:border-orange-500/30 transition-all">
          <div>
            ...
            <p className="text-[10px] text-slate-500 uppercase font-bold tracking-widest mt-2 mb-6 italic">Format: home, away, league, hProb, dProb, aProb, score, o2.5, btts, advice</p>
          </div>
